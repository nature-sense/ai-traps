...
module sbc_mount() {
    union() {
        ...
        translate([0, (sbc_mount_width+12)/2 + 4,0])
                camera_mount_side();
        translate([0, -(sbc_mount_width+12)/2+1.5,0])
                camera_mount_side();
    }
}
...
module cam_4k_camera_mount() {
    difference() {
        union() {
            ...
            translate([-cam_4k_camera_mount/2, cam_4k_camera_mount/2.75, cam_4k_bracket_thickness])
                post(cam_4k_bracket_hole,cam_4k_camera_mount_height);
        ...
        union() {
            ...
            linear_extrude(cam_4k_bracket_thickness)
             ...
             translate([0,cam_4k_bracket_width/2-cam_4k_side_thickness/2, cam_4k_bracket_thickness/2])
            ...
            translate([cam_4k_camera_mount/2,cam_4k_bracket_width/2-2.5,0])
                linear_extrude(cam_4k_bracket_thickness)
                    circle(d=cam_4k_bracket_hole, $fn=128);
            translate([cam_4k_camera_mount/2,-cam_4k_bracket_width/2+2.5,0])
                linear_extrude(cam_4k_bracket_thickness)
